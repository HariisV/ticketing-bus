...
<div class="nav-shadow"></div>
    ...
    <main>
        ...
        <div class="page-title-container">
            <div class="row">
                ...
                <div class="col-12 ">
                    ...
                    <h1 class="mb-0 pb-0 display-4" id="title">Halaman Kelola Bus</h1>
                </div>
                <!-- Title End -->
            </div>
        </div>
        ...
        <div>
            ...
            $data = $bus->select();
            ?>
        <table id="tabel-bus" class="table ">
